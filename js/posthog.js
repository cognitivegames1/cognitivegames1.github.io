// PostHog client bootstrap (provided snippet), shared by lobby and play pages.
const TELEMETRY_OPT_IN_KEY = "cg_telemetry_opt_in";
let telemetryOptIn = false;
try {
  telemetryOptIn = localStorage.getItem(TELEMETRY_OPT_IN_KEY) === "1";
} catch {
